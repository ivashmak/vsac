...
namespace Drawer {
    ...
    void drawEpipolarLines (const cv::Mat &F, const cv::Mat &pts1_, const cv::Mat &pts2_, const cv::Mat &img1_, const cv::Mat &img2_, cv::Mat &new_image, bool random_colors, int line_sz, int circle_sz, const std::vector<bool> &inliers, int offset=0, cv::Scalar back=cv::Scalar(0,0,0));
