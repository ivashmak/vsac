...
if show_H or show_F or show_F:
    ...
    if show_H: # Homography matrix
        run(pvsac.Params(1.5, pvsac.EstimationMethod.Homography, pvsac.SamplingMethod.SAMPLING_UNIFORM, 0.99, 3000, pvsac.ScoreMethod.SCORE_METHOD_MSAC),
            pts1, pts2, img1=img1, img2=img2)
    if show_F: # Fundamental matrix
        run(pvsac.Params(1.0, pvsac.EstimationMethod.Fundamental, pvsac.SamplingMethod.SAMPLING_UNIFORM, 0.99, 3000, pvsac.ScoreMethod.SCORE_METHOD_MSAC),
            pts1, pts2, img1=img1, img2=img2)
    if show_E: # Essential matrix
        run(pvsac.Params(1.0, pvsac.EstimationMethod.Essential, pvsac.SamplingMethod.SAMPLING_UNIFORM, 0.99, 3000, pvsac.ScoreMethod.SCORE_METHOD_MSAC),
...
if show_P: # P3P
    ...
    run(pvsac.Params(2.0, pvsac.EstimationMethod.P3P, pvsac.SamplingMethod.SAMPLING_UNIFORM, 0.99, 3000, pvsac.ScoreMethod.SCORE_METHOD_MSAC), pts1, pts2, K1=K)
    P_gt = K @ Rt
